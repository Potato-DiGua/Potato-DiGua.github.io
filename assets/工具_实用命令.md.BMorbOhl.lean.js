import{_ as a,c as n,a1 as p,o as i}from"./chunks/framework.B0cMFUTE.js";const k=JSON.parse('{"title":"实用命令","description":"","frontmatter":{},"headers":[],"relativePath":"工具/实用命令.md","filePath":"工具/实用命令.md"}'),l={name:"工具/实用命令.md"};function e(t,s,c,h,d,o){return i(),n("div",null,s[0]||(s[0]=[p(`<h1 id="实用命令" tabindex="-1">实用命令 <a class="header-anchor" href="#实用命令" aria-label="Permalink to &quot;实用命令&quot;">​</a></h1><ul><li><a href="#实用命令">实用命令</a><ul><li><a href="#mklink">mklink</a></li><li><a href="#快速启http服务">快速启http服务</a></li><li><a href="#合并视频和音频">合并视频和音频</a></li><li><a href="#windows备份">windows备份</a></li></ul></li></ul><h2 id="mklink" tabindex="-1">mklink <a class="header-anchor" href="#mklink" aria-label="Permalink to &quot;mklink&quot;">​</a></h2><p>创建软连接(c盘控件不足的时候可以使用)</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>MKLINK [[/D] | [/H] | [/J]] Link Target</span></span>
